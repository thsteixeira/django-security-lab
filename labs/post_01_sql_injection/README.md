...
them per-job). Install them on the host — `pip install bandit==1.9.4 semgrep==1.170.0` — and run
...
is the right place anyway, since SAST reads the source files directly.
